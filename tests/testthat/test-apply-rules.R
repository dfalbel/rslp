...
test_that("Noun Reduction Rules", {
  ...
  expect_equal(rslp:::apply_rules(escp("obrigatória"), name = "Noun", steprules = steprules), "obrig")
  ...
  expect_equal(rslp:::apply_rules(escp("referência"), name = "Noun", steprules = steprules), "refer")
  expect_equal(rslp:::apply_rules(escp("repugnância"), name = "Noun", steprules = steprules), "repugn")
  expect_equal(rslp:::apply_rules(escp("abatedouro"), name = "Noun", steprules = steprules), "abat")
  expect_equal(rslp:::apply_rules(escp("fofoqueiro"), name = "Noun", steprules = steprules), "fofoc")
  expect_equal(rslp:::apply_rules(escp("brasileiro"), name = "Noun", steprules = steprules), "brasil")
  expect_equal(rslp:::apply_rules(escp("gostoso"), name = "Noun", steprules = steprules), "gost")
  expect_equal(rslp:::apply_rules(escp("comercializaç"), name = "Noun", steprules = steprules), "comerci")
  expect_equal(rslp:::apply_rules(escp("consumismo"), name = "Noun", steprules = steprules), "consum")
  #expect_equal(rslp:::apply_rules(escp("concretizaç"), name = "Noun", steprules = steprules), "concret")
  expect_equal(rslp:::apply_rules(escp("alegaç"), name = "Noun", steprules = steprules), "aleg")
  expect_equal(rslp:::apply_rules(escp("aboliç"), name = "Noun", steprules = steprules), "abol")
  expect_equal(rslp:::apply_rules(escp("anedotário"), name = "Noun", steprules = steprules), "anedot")
  expect_equal(rslp:::apply_rules(escp("ministério"), name = "Noun", steprules = steprules), "minist")
  expect_equal(rslp:::apply_rules(escp("chinês"), name = "Noun", steprules = steprules), "chin")
  expect_equal(rslp:::apply_rules(escp("beleza"), name = "Noun", steprules = steprules), "bel")
  expect_equal(rslp:::apply_rules(escp("rigidez"), name = "Noun", steprules = steprules), "rigid")
  expect_equal(rslp:::apply_rules(escp("parentesco"), name = "Noun", steprules = steprules), "parent")
  expect_equal(rslp:::apply_rules(escp("ocupante"), name = "Noun", steprules = steprules), "ocup")
  expect_equal(rslp:::apply_rules(escp("bombástico"), name = "Noun", steprules = steprules), "bomb")
  expect_equal(rslp:::apply_rules(escp("problemático"), name = "Noun", steprules = steprules), "problem")
  expect_equal(rslp:::apply_rules(escp("polêmico"), name = "Noun", steprules = steprules), "polêm")
  expect_equal(rslp:::apply_rules(escp("produtividade"), name = "Noun", steprules = steprules), "produt")
  expect_equal(rslp:::apply_rules(escp("profundidade"), name = "Noun", steprules = steprules), "profund")
  expect_equal(rslp:::apply_rules(escp("aposentadoria"), name = "Noun", steprules = steprules), "aposentad")
  expect_equal(rslp:::apply_rules(escp("anedotário"), name = "Noun", steprules = steprules), "anedot")
  expect_equal(rslp:::apply_rules(escp("existencial"), name = "Noun", steprules = steprules), "exist")
  expect_equal(rslp:::apply_rules(escp("artista"), name = "Noun", steprules = steprules), "artista") # a regra está errada no artigo
  expect_equal(rslp:::apply_rules(escp("maluquice"), name = "Noun", steprules = steprules), "maluc")
  expect_equal(rslp:::apply_rules(escp("chatice"), name = "Noun", steprules = steprules), "chat")
  expect_equal(rslp:::apply_rules(escp("demoníaco"), name = "Noun", steprules = steprules), "demon")
  expect_equal(rslp:::apply_rules(escp("decorrente"), name = "Noun", steprules = steprules), "decorr")
  expect_equal(rslp:::apply_rules(escp("criminal"), name = "Noun", steprules = steprules), "crim")
  expect_equal(rslp:::apply_rules(escp("americano"), name = "Noun", steprules = steprules), "americ")
  #expect_equal(rslp:::apply_rules(escp("amável"), name = "Noun", steprules = steprules), "am")
  expect_equal(rslp:::apply_rules(escp("combustível"), name = "Noun", steprules = steprules), "combust")
  expect_equal(rslp:::apply_rules(escp("cobertura"), name = "Noun", steprules = steprules), "cobert")
  expect_equal(rslp:::apply_rules(escp("consensual"), name = "Noun", steprules = steprules), "consens")
  expect_equal(rslp:::apply_rules(escp("mundial"), name = "Noun", steprules = steprules), "mund")
  expect_equal(rslp:::apply_rules(escp("experimental"), name = "Noun", steprules = steprules), "experiment")
})
